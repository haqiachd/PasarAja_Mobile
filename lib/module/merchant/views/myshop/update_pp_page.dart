...
import 'package:pasaraja_mobile/module/merchant/providers/myshop/update_pp_provider.dart';
...
class _UpdatePhotoProfilePageState extends State<UpdatePhotoProfilePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<UpdatePhotoProfileProvider>().email = widget.email;
      context.read<UpdatePhotoProfileProvider>().imageFile = widget.imageFile;
    });
  }
  ...
  _buildPhotoViewer(BuildContext context) {
    return Consumer<UpdatePhotoProfileProvider>(
