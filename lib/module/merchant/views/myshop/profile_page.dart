...
import 'package:pasaraja_mobile/module/merchant/providers/myshop/profile_provider.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      try {
        await context.read<ProfileProvider>().fetchData();
      } catch (ex) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: merchantSubAppbar('Profil'),
  ...
  Align _buildPhotoProfile(ProfileProvider profile) {
    return Align(
