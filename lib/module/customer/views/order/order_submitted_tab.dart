...
class _OrderSubmittedTabState extends State<OrderSubmittedTab> {
  ...
  Future<void> _fetchData() async {
    try {
      await context.read<CustomerOrderSubmittedProvider>().fetchData();
    } catch (ex) {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async {
        context.read<CustomerOrderSubmittedProvider>().onRefresh();
        await Future.delayed(
          Duration(seconds: PasarAjaConstant.onRefreshDelaySecond),
        );
        await _fetchData();
      },
      child: Consumer<CustomerOrderSubmittedProvider>(
      ...
      onTap: () {
        Get.to(
          OrderDetailPage(
            ...
            provider: CustomerOrderSubmittedProvider(),
          ),
