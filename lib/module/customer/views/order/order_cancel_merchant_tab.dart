...
class OrderCancelMerchantTab extends StatefulWidget {
  const OrderCancelMerchantTab({Key? key}) : super(key: key);

  @override
  State<OrderCancelMerchantTab> createState() => _OrderCancelMerchantTabState();
}

class _OrderCancelMerchantTabState extends State<OrderCancelMerchantTab> {
  @override
  void initState() {
    super.initState();
  ...
  Future<void> _fetchData() async {
    try {
      await context.read<CustomerOrderCancelMerchantProvider>().fetchData();
    } catch (ex) {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async {
        context.read<CustomerOrderCancelMerchantProvider>().onRefresh();
        await Future.delayed(
          Duration(seconds: PasarAjaConstant.onRefreshDelaySecond),
        );
        await _fetchData();
      },
      child: Consumer<CustomerOrderCancelMerchantProvider>(
      ...
      onTap: () {
        Get.to(
          OrderDetailPage(
            ...
            provider: CustomerOrderCancelMerchantProvider(),
          ),
