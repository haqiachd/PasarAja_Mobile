...
import 'package:pasaraja_mobile/module/customer/provider/home/edit_account_provider.dart';
...
class _EditAccountPageState extends State<EditAccountPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      await context.read<EditAccountCustomerProvider>().setData(
        email: widget.email,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customerSubAppbar(
        'Edit Akun',
      ),
      body: Consumer<EditAccountCustomerProvider>(
  ...
  _buildInputEmail() {
    return Consumer<EditAccountCustomerProvider>(
